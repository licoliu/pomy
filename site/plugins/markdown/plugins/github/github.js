...
exports.Github = (function() {
  ...
  function _buildAuthUrl(scope) {
    return 'https://github.com/login/oauth/authorize?client_id=' + githubConfig.client_id + '&scope=' + scope + '&redirect_uri=' + githubConfig.callback_url
  }
  ...
  return {
    ...
    fetchOrgs: function(req, res) {
      ...
      request(options, function(e, r, d) {
          if (e) {
            ...
            res.json({
              error: 'Unable to fetch organizations from Github.'
            })
          }
    ...
    fetchRepos: function(req, res) {
      ...
      request(options, function(e, r, d) {
          if (e) {
            ...
            res.json({
              error: 'Unable to fetch repos from Github.'
            })
          }
        }) // end request callback
    }, // end fetchRepos
    fetchBranches: function(req, res) {
      ...
      var uri = githubApi + 'repos/' + req.body.owner + '/' + req.body.repo + '/branches?access_token=' + req.session.github.oauth
      ...
      request(options, function(e, r, d) {
          if (e) {
            ...
            res.json({
              error: 'Unable to fetch branches from Github.'
            })
          }
        }) // end request callback
    ...
    fetchTreeFiles: function(req, res) {
      ...
      uri = githubApi + 'repos/' + req.body.owner + '/' + req.body.repo + '/git/trees/' + req.body.sha + '?recursive=1&access_token=' + req.session.github.oauth;
      ...
      request(options, function(e, r, d) {
          ...
          if (e) {
            ...
            d.tree = d.tree.filter(function(item) {
            ...
            res.json({
              error: 'Unable to fetch files from Github.'
            })
          }
        }) // end request callback
    ...
    fetchFile: function(req, res) {
      ...
      request(options, function(e, r, d) {
          if (e) {
            ...
            res.json({
              error: 'Unable to fetch file from Github.'
            })
          }
        }) // end request callback
    ...
    saveToGithub: function(req, res) {
      ...
      if (!data.uri) {
        ...
        request(options, function(e, r, d) {
          ...
          return res.json(400, {
            "error": "Unable to save file: " + (e || JSON.parse(d).message)
          })
