...
var Dropbox = (function() {
    ...
    function _listMdFiles(files) {
      ...
      files.forEach(function(item) {
        ...
        list += '<li data-file-path="' + item.path + '"><a class="dropbox_file" href="#">' + item.path + '</a></li>'
      })
    ...
    return {
      ...
      putMarkdownFile: function() {
        ...
        var postData = 'pathToMdFile=' + profile.dropbox.filepath + encodeURIComponent(profile.current_filename) + (hasExtension ? '' : editorType().fileExts[0]) + '&fileContents=' + content
